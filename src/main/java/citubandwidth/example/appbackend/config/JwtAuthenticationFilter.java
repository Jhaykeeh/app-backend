package citubandwidth.example.appbackend.config;
        ...
        try {
            ...
            if (StringUtils.hasText(jwt)) {
                ...
                if (schoolId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    UserDetails userDetails = userDetailsService.loadUserByUsername(schoolId);

                    if (jwtUtil.validateToken(jwt, schoolId)) {
